...
module DogeCoin
  class Client
    ...
    def get_balance
      ...
      Faraday.get("#{BASE_URL}#{api_key}&a=get_balance").body
    end
    ...
    def withdraw(amount, payment_address)
      ...
      Faraday.get("#{BASE_URL}#{api_key}&a=withdraw&amount=#{amount}&payment_address=#{payment_address}").body
    end
    ...
    def get_new_address(address_label = nil)
      ...
      if address_label
        Faraday.get("#{BASE_URL}#{api_key}&a=get_new_address&address_label=#{address_label}").body
      else
        Faraday.get("#{BASE_URL}#{api_key}&a=get_new_address").body
      end
    end
    ...
    def get_my_addresses
      ...
      Faraday.get("#{BASE_URL}#{api_key}&a=get_my_addresses").body
    end
    ...
    def get_address_received(payment_address_or_address_label)
      ...
      Faraday.get("#{BASE_URL}#{api_key}&a=get_address_received&payment_address=#{payment_address_or_address_label}").body
    end
    ...
    def get_address_by_label(address_label)
      ...
      Faraday.get("#{BASE_URL}#{api_key}&a=get__address_by_label&address_label=#{address_label}").body
    end
